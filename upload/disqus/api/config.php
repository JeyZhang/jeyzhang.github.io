...
define('DISQUS_USERNAME', 'jeyzhang');
define('DISQUS_EMAIL', 'zhangjieup@gmail.com');
define('DISQUS_PASSWORD', 'zhj5311417');
define('DISQUS_WEBSITE', 'http://www.jeyzhang.com');
define('DISQUS_SHORTNAME', 'jeyzhang');
